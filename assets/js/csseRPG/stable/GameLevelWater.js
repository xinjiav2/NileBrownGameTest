...
class GameLevelDesert {
  constructor(gameEnv) {
    ...
    const image_data_desert = {
        name: 'Destopia',
        greeting: "Welcome to the destopia!  It is very destopian and a bad society!",
    ...
    const sprite_data_chillguy = {
        id: 'Chill Guy',
        greeting: "Hi I am Varra the god, the indian wanderer. I am looking for wisdom and adventure!",
