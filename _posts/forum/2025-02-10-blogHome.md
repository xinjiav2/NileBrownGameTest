...
<body>
    <div class="header-container">
        ...
        <a href="http://localhost:4100/portfolio_2025/blogs/post" class="post-button">Create New Blog</a>
    </div>
    <div class="container">
    ...
    <script>
        async function fetchLatestBlogs() {
            try {
                const response = await fetch('http://localhost:8085/blogs/blog/get');
                if (!response.ok) {
