...
<body>
    ...
    <script>
        ...
        document.getElementById('issueForm').addEventListener('submit', function(event) {
            ...
            if (!isLoggedIn()) {
                document.getElementById('response').innerHTML = 'Error: You must be logged in to submit an issue. Please visit <a href="/portfolio_2025/toolkit-login" style="color: #00f; text-decoration: underline;">Login</a> to log in.';
                return;
            }
            if (isLoggedIn()) {
